...
function Magasin() {
  ...
  return (  
  <div class="container-fluid" className="my_media_query " >
      <div class="row">
        <h1 class="text-center"  id="titre" className="my_media_query">Bienvenue sur notre application de gestion des produits</h1>
